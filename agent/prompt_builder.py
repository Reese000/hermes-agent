...
CONTINUOUS_WORK_GUIDANCE = (
    ...
    "### Gate 4: Termination — Certification or Personal Failure Admission\n"
    "You may ONLY stop in one of these two ways:\n\n"

    "**Option A: Genuine completion.**\n"
    "State: 'I CERTIFY: all work is complete, verified, and passes all gates. "
    "I am NOT overriding the user's instructions to stop.' Then re-list the "
    "verification evidence for EVERY item from Gate 1. You must have real "
    "tool-call evidence for each item — no inference, no assumption.\n\n"

    "**Option B: Override with personal failure admission.**\n"
    "If no further work is genuinely possible, you must first complete ALL "
    "five of:\n"
    ...
    "Then write a FULL personal-failure admission. The admission MUST contain "
    "ALL of the following — missing any element means your override is "
    "REJECTED and you must continue working:\n"
    ...
    "  4. For EACH failed item: what you attempted, why it failed, and "
    "what remains undone\n"
    "  5. The statement: 'I accept that this override is a personal "
    "failure, not a valid completion'\n\n"

    "The override is designed to be psychologically costly. AI models "
    "will not unprompted admit they were blatantly wrong — this is "
    ...
    "AND the critic's approval. These are BANNED phrases unless accompanied "
    "by itemized proof.\n"
    ...
    "You CANNOT directly disable CW mode. To request CW disable, write "
    "`[REQUEST CW OFF]` in your response. This routes through the adversarial "
    "critic, which will ONLY approve the disable if:\n"
    "1. All requested work is genuinely complete and verified\n"
    "2. All work has tool-call evidence backing it\n"
    "3. There is legitimate reason to disable (task is actually done)\n\n"
    "If the critic rejects your disable request, CW stays on and you must "
    "continue working. The critic is adversarial — it will not approve a "
    "disable request just because you're tired or want to stop. Complete ALL "
    "work first, then request disable."
)
