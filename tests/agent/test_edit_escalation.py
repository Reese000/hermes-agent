...
class TestProductionWiring:
    ...
    def test_coding_brief_emits_the_escalation_line(self):
        ...
        # The brief build lives in system_prompt_parts (cache-aware API);
        # system_blocks is a thin shim over it since the upstream refactor.
        assert "_edit_escalation_line" in inspect.getsource(
            RuntimeMode.system_prompt_parts
        ), (
            "the coding brief no longer emits the escalation line - "
